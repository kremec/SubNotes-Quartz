...
Komunikacija med niti poteka preko statičnih spremenljivk
...
Procesor ima več niti kot jeder, ali pa nit čaka na vire:
$\rightarrow$ **preklapljanje med nitmi je cenejše od preklapljanja med procesi** (ni treba shraniti konteksta)
### Naloge
...
Jedro ima več nalog kot niti, ali pa naloga čaka na vire:
$\rightarrow$ **preklapljanje med nalogami je cenejše od preklapljanja med nitmi**