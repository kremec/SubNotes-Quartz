...
- View parameters: positioning and behaviour, relative positioning/sizing for different screen size support (dp ... density-independent pixels, wrap_content/match_parent, ...)
...
- Popup menu
#### Material design
System of guidelines and components
Library
### Fragment
